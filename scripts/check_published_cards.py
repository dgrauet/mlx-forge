...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("-v", "--verbose", action="store_true", help="list every loss")
...
def main() -> None:
    ...
    for m in sorted(api.list_models(author=args.author), key=lambda x: x.id):
        repo = m.id
        try:
